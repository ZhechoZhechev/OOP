namespace OnlineShop.Models.Products.Components
{
    ...
    {
        private const double RandomAccessMemoryOverallMultiplier = 1.20;
        public RandomAccessMemory(int id, string manufacturer, string model, decimal price, double overallPerformance, int generation)
            : base(id, manufacturer, model, price, overallPerformance * RandomAccessMemoryOverallMultiplier, generation)
        {
        }
    }
}
