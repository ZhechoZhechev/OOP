namespace OnlineShop.Models.Products.Components
{
    ...
    {
        private const double SolidStateDriveOverallMultiplier = 1.20;
        public SolidStateDrive(int id, string manufacturer, string model, decimal price, double overallPerformance, int generation)
            : base(id, manufacturer, model, price, overallPerformance * SolidStateDriveOverallMultiplier, generation)
        {
        }
    }
}
